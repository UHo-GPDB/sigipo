...
const status_check = () => {
    ...
    if (surgeries.value === "3") {
        ...
        document.querySelector("textarea[name=place_where_injury_occurred]").disabled = true;
        ...
        document.querySelector("textarea[name=place_where_injury_occurred]").disabled = false;
